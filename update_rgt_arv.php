...
if (isset($_POST['btn_update'])) {
    ...
    if (!empty($id_personne)) {
      $courrier->ModiffierRgtr_arv($id_regestre_arv,$date_arrivee,$num_ordere_arv,$date_courrier_arriver,$num_lettre_arrivee,$id_dest,$objet_arriver,$date_observation,$id_type_courrier,$id_personne);
                ...
                <tr>
                    ...
                    <td style="padding-top: 5%;">
                      <div class="col">
                          ...
                          ?>
                          <option selected value="0">Chiosez une perssone</option>
                        </select>
                       </div>
                    </td>
                </tr>
