...
$reqt="SELECT `id_regestre_arv`, `date_arrivee`, `num_ordere_arv`, `date_courrier_arriver`, `num_lettre_arrivee`, `objet_arriver`, `date_observation`, pr.nom_prenom,ty.type_courrier,ds.destinataire 
...
?>
  ...
  <main class="page-content">
    <div class="container-fluid">
      <h2>Registre Arrivée</h2>
      
     
      <hr>
     <div class="d-grid gap-2 d-md-flex justify-content-md-end">
      <button type="button" class="btn btn-outline-primary" onclick="location.href='add_regestre_arrive.php'"><i class="fas fa-plus"></i>  New Arrivée</button>
      ...
      <footer class="text-center">
        ...
        <div class="card bg-wieth mb-3">
          <div class="card-header" style="color: black; margin-bottom:20px;"><h5>ARRIVEE</h5> </div>
            ...
            <table id="id_datatable_ar" style="width: 100%;" class="table table-bordered table-hover" >
          <thead>
             <tr>
                <th>Date Aujourd'hui</th>
                <th>N°Order</th>
                <th>Date Arriver</th>
                <th>N°lettre arrivee</th>
                <th>designation destinataire</th>
                <th>Objet De Courrier</th>
                <th>Date Reponse</th>
                <th>Type Courrier</th>
                <th>Personne</th>
                <th>Action</th>
