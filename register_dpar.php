...
$reqt="SELECT `id_regestre_dpr`, `date_courrier_dpr`, `num_ordere_dpr`, ds.destinataire, `objet_depart`, `signature`, `signer_par`, ty.type_courrier, `adress`, pr.nom_prenom 
...
?>
  ...
  <main class="page-content">
    <div class="container-fluid">
      <h2>Registre Depart</h2>
      
     
      <hr>
     <div class="d-grid gap-2 d-md-flex justify-content-md-end">
      <button type="button" class="btn btn-outline-primary" onclick="location.href='add_regestre_dpert.php'"><i class="fas fa-plus"></i>  New Depart</button>
      ...
      <footer class="text-center">
        ...
        <div class="card bg-wieth mb-3">
          <div class="card-header" style="color: black; margin-bottom:20px;"><h5>DEPART</h5> </div>
            ...
            <table id="id_datatable_dp" style="width: 100%;" class="table table-bordered table-hover">
          <thead>
             <tr>
                <th>N° Classement</th>
                <th>Date Courrier</th>      
           ...
           while($row=$stmt->fetch(PDO::FETCH_ASSOC)){
               ...
               <tr>
                ...
                <td>
                  <?php 
                     if(empty($row['signer_par'])){
                        echo '<span class="badge badge-pill badge-warning">Non signee</span>';
                     }else{
                       echo $row['signer_par'];
                     } 
                  ?>
                ...
                <td>
                  ...
                  <a href="register_dpar.php?delete_rgt_dp=<?php echo $row['id_regestre_dpr'];?>" onclick="return confirm('voulez vous vraiment supprimer cet personne?')">
