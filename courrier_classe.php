...
class CourrierDB{
    ...
    {
        try {
        $reqt="INSERT INTO `regestre_arrivee`(`date_arrivee`, `num_ordere_arv`, `date_courrier_arriver`, `num_lettre_arrivee`, `objet_arriver`, `date_observation`, `id_personne`, `id_type_courrier`, `id_dest`) VALUES (:date_arrivee,:num_ordere_arv,:date_courrier_arriver,:num_lettre_arrivee,:objet_arriver,:date_observation,:id_personne,:id_type_courrier,:id_dest)";
    ...
    public function ModiffierRgtr_arv($date_arrivee,$num_ordere_arv,$date_courrier_arriver,$num_lettre_arrivee
    ,$objet_arriver,$date_observation,$id_personne,$id_type_courrier,$id_dest,$id_regestre_arv)
    {
        try {

            $reqt="UPDATE `regestre_arrivee` SET `date_arrivee`=:date_arrivee,`num_ordere_arv`=:num_ordere_arv,`date_courrier_arriver`=:date_courrier_arriver,`num_lettre_arrivee`=:num_lettre_arrivee,`objet_arriver`=:objet_arriver,`date_observation`=:date_observation,`id_personne`=:id_personne`,id_type_courrier`=:id_type_courrier,`id_dest`=:id_dest WHERE `id_regestre_arv`=:id_regestre_arv";
