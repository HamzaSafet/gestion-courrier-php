...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 13 avr. 2021 à 17:08
...
--
-- Base de données : `bd_gestion_courier_fn`
--
...
INSERT INTO `regestre_arrivee` (`id_regestre_arv`, `date_arrivee`, `num_ordere_arv`, `date_courrier_arriver`, `num_lettre_arrivee`, `objet_arriver`, `date_observation`, `id_personne`, `id_type_courrier`, `id_dest`) VALUES
(5, '2021-04-13', 1, '2021-04-13', 111, 'azert', '2021-04-13', 1, 1, 1);
...
INSERT INTO `regestre_depart` (`id_regestre_dpr`, `date_courrier_dpr`, `num_ordere_dpr`, `objet_depart`, `signature`, `signer_par`, `adress`, `id_personne`, `id_type_courrier`, `id_dest`) VALUES
(1, '2021-04-14', 1, 'azerty up', 'signee', 'ADJ x', 'adress up', 3, 1, 2);
...
--
ALTER TABLE `regestre_arrivee`
  MODIFY `id_regestre_arv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `regestre_depart`
--
ALTER TABLE `regestre_depart`
  MODIFY `id_regestre_dpr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `type_courriers`
--
ALTER TABLE `type_courriers`
  MODIFY `id_type_courrier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
